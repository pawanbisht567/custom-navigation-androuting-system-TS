...
function ButtonPage() {
  ...
  return (
    <>
      ...
      <div>
        <Button className='mb-5' rounded buttonType='Danger' onMouseDown={() => { console.log() }}>
          <ImBin2/>
            Danger Button
        </Button>
      </div>
      <div>
        <Button className='mb-5' outline buttonType='Secondary' onClickCapture={() => { console.log('Clcik capture') }}>Secondary Button</Button>
      </div>
      <div>
